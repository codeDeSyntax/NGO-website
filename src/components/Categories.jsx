  ...
  return (
    <section className="w-full min-h-screen mt-10">
      <div className="w-[90%] m-auto">
        ...
        <p className="text-center text-gray-700 text-[1rem] py-2 px-20">
      ...
      <div className="w-[90%] gap-x-3 gap-y-[5rem]  m-auto h-16 md:h-20  grid grid-cols-[90%] sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-[18%,18%,18%,18%,18%] items-center justify-center py-4">
          ...
          return (
            ...
            >
              <img
                ...
                alt={category.title}
                className="w-full h-full object-cover rounded-md transition-opacity duration-300 hover:opacity-50"
              />

              <div className="p-4 lg:absolute lg:top-[60rem]">
